function! iceberg#palette#light#create() abort
  ...
  let g.pink   = pgmnt#color#hsl(hue_pink,   0.38, 0.53)
  ...
  let g.blue_search_bg = pgmnt#color#hsl(hue_lblue, 0.60, 0.80)
  let g.blue_search_fg = pgmnt#color#hsl(hue_lblue, 0.50, 0.35)
